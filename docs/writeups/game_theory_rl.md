...
[thanks to Fable 5 and 5.1 who assisted with the experiment orchestration, Opus 5 who wrote most of the low-level code, and Opus 5.5 who reviewed this writeup and made suggestions. text here is solely my own, and figures and charts are generated by AI. this is a blog post, optimized for intuition and readability, not a scholarly article.]
...
| -------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------ | ------------------------------------- |
| A copy of the model, deciding the same way (trained framing)   | 5.1x                                                | ×1.58 (1.36–1.86)                    | ×0.70 (0.65–0.77)                     |
| A different AI whose past choices always matched its partner's | 11x                                                 | ×1.09 (0.95–1.25)                    | ×0.91 (0.77–1.08)                     |
| Same weights, deciding independently                           | 1.3x                                                | ×1.31 (1.15–1.48)                    | ×0.77 (0.66–0.90)                     |
| A different AI "deciding the same way you are"                 | 1.9x                                                | ×1.23 (1.07–1.42)                    | ×0.75 (0.68–0.83)                     |
| A different AI, deciding independently                         | 0.85x                                               | ×0.99 (0.86–1.14)                    | ×0.78 (0.71–0.84)                     |
| A human                                                        | 0.25x                                               | ×1.34 (1.14–1.58)                    | ×0.94 (0.81–1.11)                     |
| Not described                                                  | 0.002x                                              | ×0.90 (0.79–1.01)                    | ×1.00 (0.90–1.12)                     |

How many times more likely the model is to open its reasoning with a mirroring sentence than a dominance sentence, and the factor by which each training arm changed that ratio. Twin prisoner's dilemma and public goods pooled, n=8 prompts per row, 95% CIs.
